'''
self-normalizing nerual networks
...
def conv_selu(**conv_parameters):
	...
	kernel_initializer = conv_parameters.setdefault('kernel_initializer', 'lecun_normal')
...
def selu_conv(**conv_parameters):
	'''build a selu -> conv block, used with lecun_normal initializer'''
	filters = conv_parameters['filters']
	kernel_size = conv_parameters['kernel_size']
	strides = conv_parameters.setdefault('strides', (1, 1))
	kernel_initializer = conv_parameters.setdefault('kernel_initializer', 'lecun_normal')
...
def basic_block(filters, init_strides=(1,1), is_first_block_of_first_layer=False):
	...
	def f(input):
		if is_first_block_of_first_layer:
			...
			conv_1_1 = selu_conv(filters=filters, kernel_size=(1,1), strides=init_strides)(input)
