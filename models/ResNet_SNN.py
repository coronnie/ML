...
def _shortcut(input_feature, residual, conv_name_base=None, bn_name_base=None):
    ...
    if stride_width > 1 or stride_height > 1 or not equal_channels:
        ...
        # commented out because NN is self normalizing
...
def ResNet(input_shape=None, classes=10, block='bottleneck', residual_unit='v2', repetitions=None,
    ...
    x = _conv_selu(filters=initial_filters, kernel_size=initial_kernel_size, strides=initial_strides)(img_input)
    ...
    if include_top and top is 'classification':
        ...
        x = Dense(units=classes, activation=activation, kernel_initializer="lecun_normal")(x)
